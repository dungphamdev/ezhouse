                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{-- @lang('cruds.user.title_singular') --}}
                            </h3>
                            @can('user.add')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('userDestroy',$user->id) }}" method="post">
                                                ...
                                                <div class="btn-group">
                                                    @can('user.edit')
                                                    <a href="{{ route('userEdit',$user->id) }}" type="button" class="btn btn-info btn-sm">
                                                         {{-- @lang('global.edit') --}}
                                                         Sửa
                                                        </a>
                                                    @endcan
                                                    <input name="_method" type="hidden" value="DELETE">
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="if (confirm('Bạn có chắc chắn?')) { this.form.submit() } ">
                                                         {{-- @lang('global.delete') --}}
                                                         Xóa
                                                        </button>
                                                </div>
